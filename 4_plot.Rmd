...
ggplot(tiz_tax_mur2, aes(x = Diversity, y = Value, color = Assemblage, group = Assemblage)) +
  geom_point(size = 3, shape = 15) +
  geom_line(size = 0.8) +
...
ggplot(cal_tax_mur2, aes(x = Diversity, y = Value, color = Assemblage, group = Assemblage)) +
  geom_point(size = 3, shape = 15) +
  geom_line(size = 0.8) +
